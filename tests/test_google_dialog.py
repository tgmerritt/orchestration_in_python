...
class TestGoogleDialog(unittest.TestCase):
    ...
    def test_send_query_to_dialogflow(self, send_query_to_dialogflow):
        ...
        print(response)
        assert response == {'answer': '{"answer":"<speak>かしこまりました。<say-as interpret-as=\\"date\\">2020-03-03</say-as>の<say-as interpret-as=\\"time\\">16:05</say-as>でよろしいですね。空き状況を確認します。しばらくお待ち下さい。</speak>","instructions":{"expressionEvent":[{}],"emotionalTone":[{"tone":"happiness","value":0.2,"start":2,"duration":4,"additive":false,"default":true}]}}', 'matchedContext': '', 'conversationPayload': ''}
