...
class TestGoogleDialog(unittest.TestCase):
    ...
    def test_send_query_to_dialogflow(self, send_query_to_dialogflow):
        gd = google_dialog.GoogleDialog({}, "blah", "632c2f78-ca23-4cc2-8c1a-ad8e2403ca64")
        response = gd.query_dialogflow()
        print(response)
        assert response == {'answer': '{"answer":"<speak>かしこまりました。<say-as interpret-as=\\"date\\">2020-03-03T12:00:00-06:00</say-as>の<say-as interpret-as=\\"time\\">16:05:00</say-as>でよろしいですね。空き状況を確認します。しばらくお待ち下さい。</speak>","instructions":{"expressionEvent":[{}],"emotionalTone":[{"tone":"happiness","value":0.2,"start":2,"duration":4,"additive":false,"default":true}]}}', 'matchedContext': '', 'conversationPayload': ''}
